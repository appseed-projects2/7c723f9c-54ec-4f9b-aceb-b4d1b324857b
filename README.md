...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-15 21:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7c723f9c-54ec-4f9b-aceb-b4d1b324857b.git
$ cd 7c723f9c-54ec-4f9b-aceb-b4d1b324857b
```
